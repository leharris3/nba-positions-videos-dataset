    ...
    while 1:
        ...
        if i == 0:
            ...
            pts = np.array([[[x1, y1],
                             ...
                             [x2, y2], \
                             [x1, y2]]])
            out = cv2.VideoWriter("omsai_masked.MOV", cv2.VideoWriter_fourcc(*'mp4v'), 30, (width, height))
        ...
        cv2.imwrite("omsai_img.jpg", masked_image)

        if (i == 1 or i%1 == 0):
            result = reader.readtext("omsai_img.jpg")
            spacer = 100
