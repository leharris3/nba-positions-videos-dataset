...
ROIS = {
    ...
    "ESP_QUARTER": {"x_start": 835, "width": 13, "y_start": 1138-560, "height": 21},
    "ESP_CLOCK": {"x_start": 885, "width": 59, "y_start": 1138-560, "height": 21},
...
def preprocess_image(image):
    ...
    def change_dpi(image, target_dpi=300):
        try:
...
def extract_timestamps_plus_trim(video_path: str, network: str):
    ...
    step = 1000  # process each step frame
    try:
